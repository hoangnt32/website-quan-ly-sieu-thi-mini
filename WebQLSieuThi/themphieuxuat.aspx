<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="themphieuxuat.aspx.cs" Inherits="themphieuxuat" %>
    ...
    <div class="content-error">
				<div class="hpanel">
                    <div class="panel-body"style="padding-left: 30px;padding-right:30px">
                        <div><h4 style="font-size:25px">Thông tin phiếu xuất</h4></div>
                               ...
                               <div class="form-group" style="padding-top:20px">
                                ...
                                <div class="form-group">
                                    <label>Sản phẩm</label>
                                     <asp:DropDownList ID="cmbmasp" CssClass="form-control" runat="server"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>Số lượng</label>
                                    <asp:TextBox ID="txtsoluong" CssClass="form-control"  runat="server" TextMode="Number"></asp:TextBox>
                                </div>
                                 <div class="form-group">
                                    <label>Ghi chú</label>
            ...
            <div class="container-fluid">
                <div class="row">
                 ...
                 <div class="form-group" style="padding-top:10px">
                      ...
                      <asp:GridView ID="gvCTPX" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="4" DataKeyNames="MaSP" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" OnRowCommand="gvCTPX_RowCommand">
                         <Columns>
...
<HeaderStyle ForeColor="White"></HeaderStyle>
             ...
             <div class="row" style="float:right" >
                 <div class="form-group" style="padding-left:40px;padding-right:20px">
                    <asp:Button ID="btninphieu" style="padding-left:18px;padding-right:18px;margin-right:8px" CssClass="btn btn-success loginbtn" runat="server" Text="Lưu phiếu" OnClick="btninphieu_Click"></asp:Button>
                     <asp:Button ID="btncapnhat" style="padding-left:18px;padding-right:18px;margin-right:8px" CssClass="btn btn-success loginbtn" runat="server" Text="Cập nhật" OnClick="btncapnhat_Click"></asp:Button>
                    <asp:Button ID="btnHuy" style="padding-left:18px;padding-right:18px;margin-right:8px" CssClass="btn btn-success loginbtn" runat="server" Text="Hủy" OnClick="btnHuy_Click"></asp:Button>
                 </div>
            </div>
        </div>      
      </div>
