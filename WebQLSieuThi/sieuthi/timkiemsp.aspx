<%@ Page Title="" Language="C#" MasterPageFile="~/sieuthi/Master.master" AutoEventWireup="true" CodeFile="timkiemsp.aspx.cs" Inherits="sieuthi_timkiemsp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="Cnt_R_C_W wapp100 fl">
     <p class="Title_Cnt_R_C_W fl"><img src="../img/logo/titile.png" /><span><asp:Label style="position:relative;top:2%" ID="lbldanhmuc" runat="server" Text="Kết quả tìm kiếm"></asp:Label></span></p>
            ...
            <asp:SqlDataSource ID="SqlSanPham" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="SELECT [MaSP], [TenSP], [GiaBan], [HinhAnh] FROM [SanPham] WHERE ([TenSP] LIKE N'%' + @TenSP + '%')">
                <SelectParameters>
