<%@ Page Title="" Language="C#" MasterPageFile="~/sieuthi/BanHangOnl.master" AutoEventWireup="true" CodeFile="donhang.aspx.cs" Inherits="sieuthi_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align:center;font-size:20px;font-weight:900;margin-top:4%">THÔNG TIN ĐƠN HÀNG</div>
...
<ItemStyle HorizontalAlign="Right" Width="110px"></ItemStyle>
        ...
        <SortedDescendingHeaderStyle BackColor="#002876" />
         ...
         <div style="text-align: right; margin-right:5%; margin-top:2%;">
...
&nbsp;<asp:Label ID="lbltongthanhtien" runat="server" Font-Size="14px" Visible="False" Font-Bold="True" Font-Italic="False"></asp:Label></div>
        <div style="margin-bottom:4%"><asp:HyperLink ID="hlHuy" style="padding:5px 10px;background-color:#045314;font-size:13px;color:#fff" NavigateUrl=<%# "javascript:xacnhanxoa('donhang.aspx?id="+ Eval("MaDH")+"',"+Eval("MaDH")+")" %> runat="server" CausesValidation="False" Text="Hủy đơn hàng" Visible="False"></asp:HyperLink></div>
             </ItemTemplate>        
     </asp:TemplateField>
   </Columns>
                </asp:GridView>
    ...
    <script language="javascript">
        function xacnhanxoa(str,ma) {
            ok = confirm("Bạn chắc chắn muốn hủy đơn hàng có mã "+ma+"?")
            if (ok != "0")
                window.location = str
        }
    </script>
